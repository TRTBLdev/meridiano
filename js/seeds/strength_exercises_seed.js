...
export const defaultStrengthCircuits = [
  {
    ...
    exercises: [
      { exerciseId: 'str-sentadilla-pelota', repsOverride: 12, durationOverride: null },
      { exerciseId: 'str-plancha-pads', repsOverride: null, durationOverride: 30 },
      { exerciseId: 'str-puente-gluteos', repsOverride: 15, durationOverride: null }
    ]
  },
  {
    ...
    exercises: [
      { exerciseId: 'str-flexiones-bloques', repsOverride: 10, durationOverride: null },
      { exerciseId: 'str-bicho-muerto', repsOverride: 10, durationOverride: null },
      { exerciseId: 'str-bisagra-cadera', repsOverride: 12, durationOverride: null }
    ]
  }
];
