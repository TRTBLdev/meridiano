export const defaultPostures = [
  ...
  { id: 'yin-caterpillar-ball', name: 'Oruga Asistida con Pelota', description: 'Estiramiento sin esfuerzo jalando, apoyando el peso sobre la pelota.', style: 'Yin', duration: 240 },
  ...
  { id: 'yin-butterfly-blocks', name: 'Mariposa con Bloques', description: 'Caderas sostenidas por bloques para evitar tensión en las ingles.', style: 'Yin', duration: 240 },
  { id: 'yin-savasana-ball', name: 'Savasana Restaurativo con Pelota', description: 'Piernas a 90 grados sobre la pelota para aplanar y aliviar la lumbar.', style: 'Yin', duration: 300 },
  { id: 'yin-supported-fish', name: 'Pez Soportado con Bloques', description: 'Abre el pecho sin requerir esfuerzo del hombro, contrarresta postura encorvada.', style: 'Yin', duration: 240 },
  { id: 'yin-spinal-twist-right-ball', name: 'Torsión Espinal Derecha con Pelota', description: 'Descomprime vértebras apoyando rodillas sobre la pelota (lado derecho).', style: 'Yin', duration: 180 },
  { id: 'yin-spinal-twist-left-ball', name: 'Torsión Espinal Izquierda con Pelota', description: 'Equilibrio lateral, relajando músculos espinales sobre la pelota (lado izquierdo).', style: 'Yin', duration: 180 },
  { id: 'yin-savasana', name: 'Savasana', description: 'Descanso final asimilando la práctica.', style: 'Yin', duration: 180 }
];
